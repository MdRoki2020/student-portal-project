    ...
    <div class="row">
	    <div class="col-sm-3">
		    <div class="list-group">
			  ...
			  <a href="add-student.php" class="list-group-item list-group-item-action active"><i class="fa fa-user-plus"></i> Add Student</a>
        ...
        <li class="breadcrumb-item active" aria-current="page">Add Student</li>
		    ...
		    <div class="row">
				...
				?>
		            <form action="add-student core.php" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
					        ...
					        <input type="text" name="pcontacts" placeholder="Student pcontacts" id="pcontacts" class="form-control" pattern="01[1|5|6|7|8|9][0-9]{8}" required/>
				        </div>
